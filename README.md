...
"Excel Text to Speech" is a Python application designed to help (any language) speakers practice building English sentences. The application presents a (for example: a Persian sentence), allowing the user to construct the English equivalent. After a short delay, the application speaks and displays the correct English sentence aloud, allowing the user to compare their attempt with the accurate translation and reinforce their learning. This method supports vocabulary acquisition, grammar practice, and improved sentence structure.

## Key Features

*   **Persian-to-English Learning:** Specifically designed for Persian speakers learning English.
*   **Excel Integration:** Reads both native sentences and their English translations from `.xlsx` or `.xls` files.
*   **Dual Text Box Display:**
    *   Displays the native sentence in one text box, prompting the user to create the English translation.
    *   After a delay, reveal the correct English sentence in a separate text box for comparison.
